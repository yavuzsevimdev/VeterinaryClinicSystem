...
{
    public class _ManagerAppointmentAllAppointmentsComponentPartial : ViewComponent
    {
        private readonly IAppointmentService _appointmentService;
        private readonly IAnimalService _animalService;
        private readonly IUserService _userService;

        public _ManagerAppointmentAllAppointmentsComponentPartial(IAppointmentService appointmentService, IAnimalService animalService, IUserService userService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            appointments = appointments.OrderBy(x => x.Date).ThenBy(x => x.Time).ToList();
